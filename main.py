...
x = float(input("Enter the box number you want to place the X."))
...
print()
x1 = float(input("Enter the box number you want to place the X."))
...
print()
o1 = float(input("Enter the box number you want to place the O."))
